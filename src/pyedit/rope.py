"""Rope-backed semantic editing, in-process.
...
textDocument/references: the caller points at the symbol. For other
languages, pyedit.lsp(command) drives a real language server through
the same position-based API.
"""
